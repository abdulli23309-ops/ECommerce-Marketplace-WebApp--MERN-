...
// ---------- Inline SVG Icons (sizes fixed) ----------
const MapPin = ({ size = 64, color = "#d1d5db" }) => (
  <svg
    style={{ width: size, height: size, color, display: "block", margin: "0 auto 16px auto" }}
    fill="none"
    stroke="currentColor"
    strokeWidth="1.5"
    viewBox="0 0 24 24"
      ...
      <div style={containerStyle}>
        ...
        {showForm && (
          <form onSubmit={handleSubmit} style={cardStyle}>
            <h3 style={{ fontWeight: 600, margin: "0 0 24px 0", fontSize: "1.1rem" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "16px" }}>
            {addresses.map((addr) => (
              ...
              >
                ...
                <p style={{ fontWeight: 500, fontSize: "1rem", color: "#111827", margin: "0 0 8px" }}>
                  {addr.fullName}
                </p>
                <p style={{ color: "#6b7280", margin: "0 0 4px", fontSize: "0.9rem" }}>
                  {addr.addressLine1}
